module.exports=[70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},24361,(e,t,r)=>{t.exports=e.x("util",()=>require("util"))},22734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},60526,(e,t,r)=>{t.exports=e.x("node:os",()=>require("node:os"))},12057,(e,t,r)=>{t.exports=e.x("node:util",()=>require("node:util"))},59639,(e,t,r)=>{t.exports=e.x("node:process",()=>require("node:process"))},12714,(e,t,r)=>{t.exports=e.x("node:fs/promises",()=>require("node:fs/promises"))},74533,(e,t,r)=>{t.exports=e.x("node:child_process",()=>require("node:child_process"))},57764,(e,t,r)=>{t.exports=e.x("node:url",()=>require("node:url"))},46069,(e,t,r)=>{t.exports=e.x("argon2",()=>require("argon2"))},45706,(e,t,r)=>{t.exports=e.x("querystring",()=>require("querystring"))},6461,(e,t,r)=>{t.exports=e.x("zlib",()=>require("zlib"))},75096,e=>{e.v({name:"openid-client",version:"5.7.1",description:"OpenID Connect Relying Party (RP, Client) implementation for Node.js runtime, supports passportjs",keywords:["auth","authentication","basic","certified","client","connect","dynamic","electron","hybrid","identity","implicit","oauth","oauth2","oidc","openid","passport","relying party","strategy"],homepage:"https://github.com/panva/openid-client",repository:"panva/openid-client",funding:{url:"https://github.com/sponsors/panva"},license:"MIT",author:"Filip Skokan <panva.ip@gmail.com>",exports:{types:"./types/index.d.ts",import:"./lib/index.mjs",require:"./lib/index.js"},main:"./lib/index.js",types:"./types/index.d.ts",files:["lib","types/index.d.ts"],scripts:{format:"npx prettier --loglevel silent --write ./lib ./test ./certification ./types",test:"mocha test/**/*.test.js"},dependencies:{jose:"^4.15.9","lru-cache":"^6.0.0","object-hash":"^2.2.0","oidc-token-hash":"^5.0.3"},devDependencies:{"@types/node":"^16.18.106","@types/passport":"^1.0.16",base64url:"^3.0.1",chai:"^4.5.0",mocha:"^10.7.3",nock:"^13.5.5",prettier:"^2.8.8","readable-mock-req":"^0.2.2",sinon:"^9.2.4",timekeeper:"^2.3.1"},"standard-version":{scripts:{postchangelog:"sed -i '' -e 's/### \\[/## [/g' CHANGELOG.md"},types:[{type:"feat",section:"Features"},{type:"fix",section:"Fixes"},{type:"chore",hidden:!0},{type:"docs",hidden:!0},{type:"style",hidden:!0},{type:"refactor",section:"Refactor",hidden:!1},{type:"perf",section:"Performance",hidden:!1},{type:"test",hidden:!0}]}})},53174,e=>{"use strict";var t=e.i(89171),r=e.i(79832);async function i(){let e=await (0,r.auth)();return e?.user?.id?e.isAdmin?{session:e}:{response:t.NextResponse.json({error:"Acceso admin requerido"},{status:403})}:{response:t.NextResponse.json({error:"Autenticación requerida"},{status:401})}}e.s(["requireAdminSession",()=>i])},44540,e=>{"use strict";var t=e.i(75705);function r(e){return String(e??"").trim()}async function i(){let e=await (0,t.getPool)();return((await e.request().query(`
  ...
  `)).recordset??[]).map(e=>({newsId:String(e.newsId),communityId:String(e.communityId),communityName:String(e.communityName??""),communitySlug:String(e.communitySlug??""),title:String(e.title??""),slug:String(e.slug??""),isPublic:!!e.isPublic,isFeatured:!!e.isFeatured,publishedAt:e.publishedAt instanceof Date?e.publishedAt:e.publishedAt?new Date(e.publishedAt):null,createdAt:e.createdAt instanceof Date?e.createdAt:e.createdAt?new Date(e.createdAt):null,updatedAt:e.updatedAt instanceof Date?e.updatedAt:e.updatedAt?new Date(e.updatedAt):null}))}async function n(e){let i=r(e);if(!i)return null;let n=await (0,t.getPool)(),s=await n.request().input("newsId",i).query(`
    ...
    `),a=s.recordset?.[0];return a?{newsId:String(a.newsId),communityId:String(a.communityId),title:String(a.title??""),slug:String(a.slug??""),summary:String(a.summary??""),bodyHtml:String(a.bodyHtml??""),imageUrl:null==a.imageUrl?null:String(a.imageUrl),isFeatured:!!a.isFeatured,isPublic:!!a.isPublic,sortOrder:"number"==typeof a.sortOrder?a.sortOrder:null==a.sortOrder?null:Number(a.sortOrder),publishedAt:a.publishedAt instanceof Date?a.publishedAt:a.publishedAt?new Date(a.publishedAt):null,createdAt:a.createdAt instanceof Date?a.createdAt:a.createdAt?new Date(a.createdAt):null,updatedAt:a.updatedAt instanceof Date?a.updatedAt:a.updatedAt?new Date(a.updatedAt):null}:null}async function s(e){let r=await (0,t.getPool)(),i=await r.request().input("communityId",e).query(`
      SELECT TOP 1 CommunityId
      FROM cms.Communities
      WHERE CAST(CommunityId AS NVARCHAR(50)) = CAST(@communityId AS NVARCHAR(50))
    `);if(!i.recordset?.[0])throw Error("Comunidad no encontrada")}async function a(e,r,i){let n=(await (0,t.getPool)()).request().input("communityId",e).input("slug",r),s=i?"AND CAST(NewsId AS NVARCHAR(50)) <> CAST(@excludeNewsId AS NVARCHAR(50))":"";i&&n.input("excludeNewsId",i);let a=await n.query(`
    SELECT TOP 1 NewsId
    FROM cms.News
    WHERE CAST(CommunityId AS NVARCHAR(50)) = CAST(@communityId AS NVARCHAR(50))
      AND LOWER(Slug) = LOWER(@slug)
      ${s}
  `);if(a.recordset?.[0])throw Error("Ya existe una noticia con ese slug para esta comunidad.")}function o(e){let t=r(e.communityId),i=r(e.title),n=String(e.slug??"").trim().toLowerCase(),s=r(e.summary),a=r(e.bodyHtml),o=String(e.imageUrl??"").trim()||null,u=!!e.isFeatured,d=e.isPublic??!0,l="number"==typeof e.sortOrder&&Number.isFinite(e.sortOrder)?Math.trunc(e.sortOrder):null;if(!t)throw Error("CommunityId obligatorio");if(!i)throw Error("Title obligatorio");if(!n)throw Error("Slug obligatorio");if(!s)throw Error("Summary obligatorio");if(!a)throw Error("BodyHtml obligatorio");if(null!==l&&l<0)throw Error("Orden invalido");return{communityId:t,title:i,slug:n,summary:s,bodyHtml:a,imageUrl:o,isFeatured:u,isPublic:d,sortOrder:l,hasSortOrder:null!==l}}async function u(e){let{communityId:r,title:i,slug:n,summary:u,bodyHtml:d,imageUrl:l,isFeatured:c,isPublic:p,sortOrder:m,hasSortOrder:A}=o(e);await s(r),await a(r,n);let S=await (0,t.getPool)(),y=await S.request().input("communityId",r).input("title",i).input("slug",n).input("summary",u).input("bodyHtml",d).input("imageUrl",l).input("isFeatured",c).input("isPublic",p).input("hasSortOrder",A).input("sortOrder",m??0).query(`
    ...
    `),h=y.recordset?.[0];if(!h?.newsId)throw Error("No se pudo guardar la noticia");return{newsId:String(h.newsId)}}async function d(e){let i=r(e.newsId);if(!i)throw Error("NewsId obligatorio");if(!await n(i))throw Error("Noticia no encontrada");let{communityId:u,title:d,slug:l,summary:c,bodyHtml:p,imageUrl:m,isFeatured:A,isPublic:S,sortOrder:y,hasSortOrder:h}=o(e);await s(u),await a(u,l,i);let g=await (0,t.getPool)();return await g.request().input("newsId",i).input("communityId",u).input("title",d).input("slug",l).input("summary",c).input("bodyHtml",p).input("imageUrl",m).input("isFeatured",A).input("isPublic",S).input("hasSortOrder",h).input("sortOrder",y??0).query(`
      UPDATE cms.News
    ...
    `),{newsId:i}}e.s(["createAdminNews",()=>u,"getAdminNewsById",()=>n,"listAdminNews",()=>i,"updateAdminNews",()=>d])},34725,e=>{"use strict";var t=e.i(47909),r=e.i(74017),i=e.i(96250),n=e.i(59756),s=e.i(61916),a=e.i(14444),o=e.i(37092),u=e.i(69741),d=e.i(16795),l=e.i(87718),c=e.i(95169),p=e.i(47587),m=e.i(66012),A=e.i(70101),S=e.i(26937),y=e.i(10372),h=e.i(93695);e.i(52474);var g=e.i(220),w=e.i(89171),x=e.i(53174),E=e.i(44540);function f(e,t){return e instanceof Error?e.message:t}async function R(){let e=await (0,x.requireAdminSession)();if("response"in e)return e.response;try{let e=await (0,E.listAdminNews)();return w.NextResponse.json({items:e})}catch(e){return w.NextResponse.json({error:f(e,"No se pudieron cargar las noticias")},{status:400})}}async function b(e){let t=await (0,x.requireAdminSession)();if("response"in t)return t.response;try{let t=await e.json(),r=await (0,E.createAdminNews)({communityId:t?.communityId,title:t?.title,slug:t?.slug,summary:t?.summary,bodyHtml:t?.bodyHtml,imageUrl:t?.imageUrl,isFeatured:!!t?.isFeatured,isPublic:t?.isPublic??!0,sortOrder:function(e){if(null==e||""===e)return null;let t=Number(e);if(!Number.isFinite(t)||t<0)throw Error("Orden inválido");return Math.trunc(t)}(t?.sortOrder)});return w.NextResponse.json(r,{status:201})}catch(e){return w.NextResponse.json({error:f(e,"No se pudo guardar la noticia")},{status:400})}}e.s(["GET",()=>R,"POST",()=>b,"dynamic",0,"force-dynamic","runtime",0,"nodejs"],37244);var I=e.i(37244);let N=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/admin/news/route",pathname:"/api/admin/news",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/admin/news/route.ts",nextConfigOutput:"standalone",userland:I}),{workAsyncStorage:C,workUnitAsyncStorage:T,serverHooks:v}=N;function O(){return(0,i.patchFetch)({workAsyncStorage:C,workUnitAsyncStorage:T})}async function P(e,t,i){N.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let w="/api/admin/news/route";w=w.replace(/\/index$/,"")||"/";let x=await N.prepare(e,t,{srcPage:w,multiZoneDraftMode:!1});if(!x)return t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:E,params:f,nextConfig:R,parsedUrl:b,isDraftMode:I,prerenderManifest:C,routerServerContext:T,isOnDemandRevalidate:v,revalidateOnlyGenerated:O,resolvedPathname:P,clientReferenceManifest:q,serverActionsManifest:H}=x,U=(0,u.normalizeAppPath)(w),D=!!(C.dynamicRoutes[U]||C.routes[P]),j=async()=>((null==T?void 0:T.render404)?await T.render404(e,t,b,!1):t.end("This page could not be found"),null);if(D&&!I){let e=!!C.routes[P],t=C.dynamicRoutes[U];if(t&&!1===t.fallback&&!e){if(R.experimental.adapterPath)return await j();throw new h.NoFallbackError}}let F=null;!D||N.isDev||I||(F="/index"===(F=P)?"/":F);let L=!0===N.isDev||!D,k=D&&!L;H&&q&&(0,a.setReferenceManifestsSingleton)({page:w,clientReferenceManifest:q,serverActionsManifest:H,serverModuleMap:(0,o.createServerModuleMap)({serverActionsManifest:H})});let M=e.method||"GET",_=(0,s.getTracer)(),V=_.getActiveScopeSpan(),B={params:f,prerenderManifest:C,renderOpts:{experimental:{authInterrupts:!!R.experimental.authInterrupts},cacheComponents:!!R.cacheComponents,supportsDynamicResponse:L,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:R.cacheLife,waitUntil:i.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,i)=>N.onRequestError(e,t,i,T)},sharedContext:{buildId:E}},W=new d.NodeNextRequest(e),$=new d.NodeNextResponse(t),K=l.NextRequestAdapter.fromNodeNextRequest(W,(0,l.signalFromNodeResponse)(t));try{let a=async e=>N.handle(K,B).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=_.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=r.get("next.route");if(i){let t=`${M} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${w}`)}),o=!!(0,n.getRequestMeta)(e,"minimalMode"),u=async n=>{var s,u;let d=async({previousCacheEntry:r})=>{try{if(!o&&v&&O&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await a(n);e.fetchMetrics=B.renderOpts.fetchMetrics;let u=B.renderOpts.pendingWaitUntil;u&&i.waitUntil&&(i.waitUntil(u),u=void 0);let d=B.renderOpts.collectedTags;if(!D)return await (0,m.sendResponse)(W,$,s,B.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,A.toNodeOutgoingHttpHeaders)(s.headers);d&&(t[y.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==B.renderOpts.collectedRevalidate&&!(B.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&B.renderOpts.collectedRevalidate,i=void 0===B.renderOpts.collectedExpire||B.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:B.renderOpts.collectedExpire;return{value:{kind:g.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:i}}}}catch(t){throw(null==r?void 0:r.isStale)&&await N.onRequestError(e,t,{routerKind:"App Router",routePath:w,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:v})},T),t}},l=await N.handleResponse({req:e,nextConfig:R,cacheKey:F,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:C,isRoutePPREnabled:!1,isOnDemandRevalidate:v,revalidateOnlyGenerated:O,responseGenerator:d,waitUntil:i.waitUntil,isMinimalMode:o});if(!D)return null;if((null==l||null==(s=l.value)?void 0:s.kind)!==g.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(u=l.value)?void 0:u.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});o||t.setHeader("x-nextjs-cache",v?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),I&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,A.fromNodeOutgoingHttpHeaders)(l.value.headers);return o&&D||c.delete(y.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,S.getCacheControlHeader)(l.cacheControl)),await (0,m.sendResponse)(W,$,new Response(l.value.body,{headers:c,status:l.value.status||200})),null};V?await u(V):await _.withPropagatedContext(e.headers,()=>_.trace(c.BaseServerSpan.handleRequest,{spanName:`${M} ${w}`,kind:s.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},u))}catch(t){if(t instanceof h.NoFallbackError||await N.onRequestError(e,t,{routerKind:"App Router",routePath:U,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:v})}),D)throw t;return await (0,m.sendResponse)(W,$,new Response(null,{status:500})),null}}e.s(["handler",()=>P,"patchFetch",()=>O,"routeModule",()=>N,"serverHooks",()=>v,"workAsyncStorage",()=>C,"workUnitAsyncStorage",()=>T],34725)},33779,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__347657e3._.js"].map(t=>e.l(t))).then(()=>t(56261)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__15810419._.js.map